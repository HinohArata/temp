...
public class UpdatesListAdapter extends RecyclerView.Adapter<UpdatesListAdapter.ViewHolder> {
    ...
    // PERUBAHAN: Konstruktor menerima Context dan Callback
                        ...
                        (dialog, which) -> {
                            if (checkbox.isChecked()) {
                                preferences.edit()
                                        ...
                                        .apply();
                                // Cast ke Activity untuk invalidate options menu
    ...
    private void openDownloadUrl(String downloadId) {
        ...
        if (update != null && update.getDownloadUrl() != null) {
            try {
                ...
                mContext.startActivity(intent);  // Mulai activity untuk membuka URL
            } catch (Exception e) {
