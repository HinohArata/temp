/*
 * Copyright (C) AfterlifeOS Project
 *
...
public class UpdatesHomeView extends Fragment implements UpdateImporter.Callbacks, UpdatesListCallback {

    private static final String TAG = "UpdatesHomeView";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MaterialCardView headerIconContainer = view.findViewById(R.id.header_icon_container);

        if (headerIconContainer != null) {
            ImageView headerIcon = view.findViewById(R.id.header_icon);
            if (headerIcon != null) {
                headerIcon.setImageResource(R.drawable.ic_afterlife_logo);
                int padding = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 12, getResources().getDisplayMetrics());
                headerIcon.setPadding(padding, padding, padding, padding);
            }
        }
        ...
        TextView relTypeVersion = view.findViewById(R.id.header_reltype);
        relTypeVersion.setText
                (getString(R.string.header_title_reltype, BuildInfoUtils.getReleaseType()));

        TextView headerAflVersion = view.findViewById(R.id.header_afl_version);
        headerAflVersion.setText(getString(R.string.header_afterlife_version,
                BuildInfoUtils.getBuildVersion(), BuildInfoUtils.getAfterlifeVersion()));
