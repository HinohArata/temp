...
public class UpdatesChangelogsView extends Fragment {
    private TextView mChangelogText;
    private ProgressBar mProgressBar;
    private int fgSpanColor;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fgSpanColor = ContextCompat.getColor(requireContext(), R.color.color_blue_cl);
    ...
    private void fetchChangelog() {
        ...
        String dynamicUrl = Utils.getChangelogMdURL(requireContext());
                ...
                .usePlugin(new AbstractMarkwonPlugin() {
                    ...
                    public void configureSpansFactory(@NonNull MarkwonSpansFactory.Builder builder) {
                        builder.setFactory(StrongEmphasis.class, (configuration, props) -> new Object[]{
                                ...
                                new ForegroundColorSpan(fgSpanColor)
                        });
                    }
                })
                .build();
